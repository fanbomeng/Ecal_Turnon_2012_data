...
void Emulstudy_LC()
{
   TFile *f1 =new TFile("elepairs_360_369_LC.root");
   TTree *treeChain1 = (TTree*)f1->Get("ElePairs");
   TFile *f2 =new TFile("elepairs_360_369.root");
   TTree *treeChain2 = (TTree*)f2->Get("ElePairs");
...
//  formatHisto(0,legname,legendname,"Emul ADC",0,150,"EmulADC", colors,&EmulAdc[0],2,"EmulADC_new_before.pdf",dirctoryname); 
  formatHisto(0,legname,legendname,"Emul ADC",0,250,"EmulADC ratio", colors,&EmulAdcRatioEB,1,"EmulADC_ratio.pdf",dirctoryname); 
}
