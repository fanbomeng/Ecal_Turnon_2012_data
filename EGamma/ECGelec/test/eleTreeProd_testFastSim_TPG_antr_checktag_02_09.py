...
process.source = cms.Source("PoolSource",
                            ...
                            fileNames = cms.untracked.vstring(
                             # "root://cms-xrd-global.cern.ch//store/data/Run2012A/DoubleElectron/RAW-RECO/ZElectron-22Jan2013-v1/20000/02A1EC8D-8C67-E211-9729-002618943864.root"                   
                              "root://eoscms.cern.ch//eos/cms/store/user/fmeng/0008202C-E78F-E211-AADB-0026189437FD.root"                  #Run: 207905, 207515, 207269, 207454, 207273 
...
process.TFileService = cms.Service ("TFileService", 
                                    fileName = cms.string ("tree_testFastSim_TPG_laser_02_09.root")
                                    )
