...
//    jsonMap[i] = readJSONFile(jsonFile[i]);
  if (debug) cout <<"Skipping json reader" << endl;
...
void selectPairs_test(int nEntries=-1, int iEff=0, int iEff_M=0, TString eg_menu="L1_EG_MENU_2011",
//		 TString dirOut="/home/llr/cms/antropov/CMSSW_539p3L1EG/src/EGamma/ECGelec/test/selectPairsTest_sfgvb24/",
//		 TString dirIn="/home/llr/cms/antropov/CMSSW_539p3L1EG/src/EGamma/ECGelec/test/",
		 TString dirOut="",
		 TString dirIn="",
