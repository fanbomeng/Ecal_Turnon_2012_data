...
void fitEfficiency_test(unsigned int iEG, int iECAL1, int iColl1, int iECAL2, int iColl2,
			 TString dirIn="/home/llr/cms/antropov/CMSSW_539p3L1EG/src/EGamma/ECGelec/test/selectPairsTest_sfgvb14",
			 ...
			 TString probe="WP80", TString tag="WP80", TString fileIn="tree_effi_TagProbe.root")
{
  ...
  gROOT->ProcessLine(".!mkdir -p " + dirResults);
  TString name_image = 
