...
void fittrial()
{
      fastEfficiencyNadir(iEG=1,iECAL1=1,iColl1=1,iECAL2=1,iColl2=1,
			  dirIn="/afs/cern.ch/user/f/fmeng/fanboworkingarea/cmssw_6_2_0/src/l1studies/egamma/macros/efficiency/makepairstest/", 
			  lumi="200 pb",nCPU=4, 
			  color1=kBlack,  style1=kFullCircle, color2=kRed,style2=kOpenSquare,
			  TString probe="WP80", TString tag="WP80", TString fileIn="*.root");
