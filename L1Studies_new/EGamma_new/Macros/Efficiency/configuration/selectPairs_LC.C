...
//   } 
  ...
  */
  ...
  //jsonFile[0] = jsonDir + "Collisions11/7TeV/Reprocessing/goodrunlist_json.txt" ;
  jsonFile[0] = jsonDir + "Collisions11/7TeV/Reprocessing/Cert_160404-163869_7TeV_May10ReReco_Collisions11_JSON_v3.txt" ;
  jsonFile[1] = jsonDir + "Collisions11/7TeV/Reprocessing/Cert_170249-172619_7TeV_ReReco5Aug_Collisions11_JSON_v3.txt" ;
  jsonFile[2] = jsonDir + "Collisions11/7TeV/Reprocessing/Cert_160404-180252_7TeV_PromptReco_Collisions11_JSON.txt" ;
  jsonFile[3] = jsonDir + "Collisions11/7TeV/Reprocessing/Cert_160404-180252_7TeV_ReRecoNov08_Collisions11_JSON.txt" ;
  if (DEBUG)  cout << __PRETTY_FUNCTION__ << " " << __LINE__ << endl;
  // 2012
  jsonFile[4] = jsonDir + "Collisions12/8TeV/Prompt/Cert_190456-203002_8TeV_PromptReco_Collisions12_JSON.txt";
  jsonFile[5] = jsonDir + "Collisions12/8TeV/Reprocessing/Cert_190456-196531_8TeV_13Jul2012ReReco_Collisions12_JSON_v2.txt";
  jsonFile[6] = jsonDir + "Collisions12/8TeV/Reprocessing/Cert_190782-190949_8TeV_06Aug2012ReReco_Collisions12_JSON.txt";
  jsonFile[7] = jsonDir + "Collisions12/8TeV/Reprocessing/Cert_198022-198523_8TeV_24Aug2012ReReco_Collisions12_JSON.txt";
  if (DEBUG)  cout << jsonFile[8] << endl;
...
//     }
  ...
  if (DEBUG)  cout << __PRETTY_FUNCTION__ << " " << __LINE__ << endl;
  // OUTPUT FILE //
  TFile *outfile = new TFile(dirOut+"tree_effi_TagProbe|num1|to|num2|.root","RECREATE");
  for(int iECAL=0 ; iECAL<nECAL ; iECAL++ ) {
    for(int iColl=0 ; iColl<nColl ; iColl++) {
...
void selectPairs_LC(int nEntries=-1, int iEff=0, int iEff_M=0, TString eg_menu="L1_EG_MENU_2011",
		 TString dirOut="result|num1|to|num2|/",
		 TString dirIn="/tmp/fmeng/data|num1|to|num2|/",
...
//  TString file = "*.root";
 // TString file = "root://eoscms//eos/cms/store/user/fmeng/Crab3/selectPair_LC/elepairs|num1|to|num2|.root";
  TString file = "elepairs|num1|to|num2|.root";
  if (DEBUG)  cout << __PRETTY_FUNCTION__ << " " << __LINE__ << endl;
  ...
  */
  ...
  if (DEBUG)  cout <<  myChain->GetName() << endl;
  if (DEBUG)  cout << __PRETTY_FUNCTION__ << " " << __LINE__ << endl;
