...
void makePairs_test(int nEntries=-1, int iHalf=0, int nHalf=1,
	       TString dirOut="~/FANBOWORKINGAREA/CMSSW_539p3L1EG/src/EGamma/ECGelec/test/MakePairsTest",
	       TString dirIn="~/FANBOWORKINGAREA/CMSSW_539p3L1EG/src/EGamma/ECGelec/test/",
	       ...
	       int iJson=-1, TString RunPhase="2011A", bool debug=false)
{
  ...
  treeList.push_back("~/FANBOWORKINGAREA/CMSSW_539p3L1EG/src/EGamma/ECGelec/test/tree_testFastSim_TPG_sfgvb24.root");
