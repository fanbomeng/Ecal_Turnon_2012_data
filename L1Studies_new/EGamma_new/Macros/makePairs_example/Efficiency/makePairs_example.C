...
#include "tree_list_Run2012A_ZElectron_22Jan2013_v1__sfgvb14_killing18.C"
void makePairs_example(int nEntries=-1, int iHalf=0, int nHalf=1,
	       TString dirOut="",
//	       TString dirIn="/home/llr/cms/antropov/CRAB/data/EGamma_ECGelec_eleTreeProd/Run2012A-ZElectron-22Jan2013-v1/sfgvb14/PairsTree/",
	       TString dirIn="./",
	       TString data="Run2012C_22Jan",
	       TString nameChain="produceNtuple/eIDSimpleTree", 
	       int iJson=-1, TString RunPhase="2012C", bool debug=false)
{
  // Output Log
  ...
  treeList = tree_list_Run2012A_ZElectron_22Jan2013_v1__sfgvb14_killing18();

//  treeList.push_back("/home/llr/cms/antropov/CMSSW_539p3L1EG/src/EGamma/ECGelec/test/tree_testFastSim_TPG_sfgvb24.root");
//  treeList.push_back("root://polgrid4.in2p3.fr//store/user/iantropo/DoubleElectron/Run2012A-ZElectron-22Jan2013-v1_RAW-RECO/sfgvb14/eleTree_TPG_sfgvb14_10_1_cx7.root");
